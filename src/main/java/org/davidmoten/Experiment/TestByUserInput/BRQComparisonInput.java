...
//            updateItems[i] = randomIndex;
            ...
            if ((i + 1) % batchSize == 0) {
                ...
                // 打印平均搜索时间
                System.out.printf("Update完成，平均更新时间: | RSKQ_Biginteger: |%-10.6f|ms| SKQ_Biginteger: |%-10.6f|ms\n",
        ...
        while (true) {
            ...
            switch (choice) {
                case 1: // 搜索操作
                    ...
                    // 打印平均搜索时间
                    System.out.printf("搜索完成，平均搜索时间: | RSKQ_Biginteger: |%-10.6f|ms| SKQ_Biginteger: |%-10.6f|ms\n",
