...
//import java.util.*;
//
//public class RunningTimeExp_BITSET {
//    public static void main(String[] args) throws Exception {
//        long times = System.nanoTime() % 999;
//        // 定义实验参数
...
//                // 创建输出目录
//                String dirName = "src/results/UpdateRunTime_" + times + "/k" + k + "_maxfiles_" + maxfiles;
...
//                                        TDSC2023_BITSET tdsc2023 = new TDSC2023_BITSET(128, 200, maxfiles, order, 2);
//                                        runExperiments(tdsc2023, k, l, expTimes, filepath, maxfiles, out, dirName);
//                                    }
//
...
//            spqs.ObjectUpdate(pSet, W, "add", new int[]{1}, 200);
...
//            tdsc2023.update(pSet, W, "add", new int[]{1}, 200);
...
//        // Add Update
//        spqs.ObjectUpdate(pSet, W, "add", files, 200);
//        // Search
////        BigInteger BR = spqs.ObjectSearch(R_min, R_max, WQ);
//        // 返回最终解密后的位图信息
...
//
//        // Del Update
////        spqs.ObjectUpdate(pSet, W, "del", files, 200);
//    }
//
...
//        // Add Update
//        tdsc2023.update(pSet, W, "add", files, 200);
//
//        // Search
////        BigInteger BR = tdsc2023.Search(R_min, R_max, WQ);
//        // 返回最终解密后的位图信息
...
//
//        // Del Update
////        tdsc2023.update(pSet, W, "del", files, 200);
//    }
//
//
//    // 随机选取W中的k个关键字
