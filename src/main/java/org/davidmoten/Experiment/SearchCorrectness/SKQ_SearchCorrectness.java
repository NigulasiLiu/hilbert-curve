...
import org.davidmoten.Scheme.SKQ.DPRF.BRC_DPRF;
...
public class SKQ_SearchCorrectness {
...
//    private String filePath; // 数据集路径
    ...
    // 修改后的构造函数
    public SKQ_SearchCorrectness(int securityParameter, int maxnums_w, int maxFiles, int order, int dimension) throws Exception {
...
//        findIndexesOfOne(BR);
        ...
        // 输出总耗时
//        double totalLoopTimeMs = (System.nanoTime() - startTime) / 1_000_000.0;
//        System.out.println("SKQ_SearchCorrectness Total search time: " + totalLoopTimeMs + " ms).");
        // 客户端部分结束计时
...
//            System.out.println("已移除 totalUpdateTimes 列表中的最大值和最小值。");
    ...
    public static void main(String[] args) throws Exception {
        ...
        // 初始化 SKQ_SearchCorrectness 实例
        SKQ_SearchCorrectness tdsc2023 = new SKQ_SearchCorrectness(securityParameter, maxnums_w, maxFiles, order, dimension);
